...
public class GenericApplicationReleaseDAOImpl extends AbstractDAOImpl implements ApplicationReleaseDAO {
    ...
    @Override
    public int addStars(String version, int appId,int stars,ApplicationRelease applicationRelease) throws ApplicationManagementDAOException {
...
//
            ...
            stmt.setInt(1, applicationRelease.getId());
            stmt.executeUpdate();
            insertApplicationReleaseProperties(connection, applicationRelease);
           ...
           resultSet = statement.getResultSet();
            ...
            throw new ApplicationManagementDAOException(
                    "SQL Exception while trying to add stars to an application (UUID : " + applicationRelease
                            .getApplication().getUuid() + "), by executing the query " +  e);
        } catch (DBConnectionException e) {
            throw new ApplicationManagementDAOException(
...
//        }
    ...
    @Override
    public int getStars(String version, String appName) throws ApplicationManagementDAOException {
        Connection connection;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
    ...
    @Override
    public int insertStars(String version, int appId, int stars) throws ApplicationManagementDAOException {
        Connection connection;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        ApplicationRelease applicationRelease = null;
    ...
    @Override
    public int getRatedUser(String version, String appName) throws ApplicationManagementDAOException {
        Connection connection;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
