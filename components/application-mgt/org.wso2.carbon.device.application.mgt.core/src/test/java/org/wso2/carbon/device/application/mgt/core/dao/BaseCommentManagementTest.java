...
//
//public class BaseCommentManagementTest {
//
//    private DataSource dataSource;
//    private static final Log log = LogFactory.getLog(BaseCommentManagementTest.class);
//
//    @BeforeSuite
...
//        ApplicationManagementDAOFactory.init(dataSource.toString());
//
//    }
//
...
//    }
//
//    private DataSourceConfig readDataSourceConfig() throws ApplicationManagementException, DeviceManagementException {
//        try {
//            File file = new File("src/test/resources/data-source-config.xml");
...
import org.wso2.carbon.device.mgt.common.DeviceManagementException;
import org.wso2.carbon.device.application.mgt.core.TestUtils;
import org.wso2.carbon.device.mgt.core.util.DeviceManagerUtil;
...
public abstract class BaseCommentManagementTest {
...
//            conn = this.getDataSource().getConnection();
//            stmt = conn.createStatement();
//            stmt.executeUpdate("RUNSCRIPT FROM './src/test/resources/mysql.sql'");
//        } finally {
//            TestUtils.cleanupResources(conn, stmt, null);
//        }
//    }
...
//            Assert.fail(msg, e);
    ...
    private void cleanupGroupData(Connection conn) throws SQLException {
        try (PreparedStatement stmt = conn.prepareStatement("DELETE FROM AP_APP_RELEASE")) {
            stmt.execute();
        }
    }
